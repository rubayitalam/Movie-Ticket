...
const SeatLayout = () => {
    ...
    const getShow = async () => {
        // Simulating an API call to fetch show details
        ...
        <div className="flex flex-col md:flex-row px-6 md:px-16 lg:px-40 py-32 md:pt-52">
            ...
            <div className="relative flex-1 flex flex-col items-center max-md:mt-16">
                ...
                <button
                    ...
                    className="flex items-center gap-1 mt-20 px-10 py-3 text-sm bg-primary hover:bg-primary-dull transition rounded-full font-medium cursor-pointer active:scale-95 mx-auto"
                >
                    Proceed to Checkout
