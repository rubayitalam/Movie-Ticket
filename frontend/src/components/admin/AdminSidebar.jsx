...
const AdminSidebar = () => {
    ...
    return (
        <div className="h-[calc(100vh-64px)] md:flex flex-col items-center pt-8 max-w-14 md:max-w-60 w-full border-r border-gray-300/30 text-sm">
            <img
                src={user.imageUrl}
                alt="Profile"
                className="h-9 md:h-14 w-9 md:w-14 rounded-full mx-auto mb-4  object-cover"
            />
